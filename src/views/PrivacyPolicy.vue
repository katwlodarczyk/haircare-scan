<template>
  <div
    class="w-full flex flex-col justify-start text-left pt-28 pb-36 px-6 space-y-2"
  >
    <h1 class="text-2xl">PRIVACY POLICY</h1>
    <p class="">Last updated 22.03.2022</p>
    <div class="text-sm flex flex-col space-y-2">
      <p>
        Thank you for choosing to be part of our community (“Company”, “we”,
        ...
        carefully, as it is important. <br />
        If there are any terms in this privacy policy that you do not agree
        with, please discontinue use of our Sites and our services. <br />This
        privacy policy applies to all information collected through our website
        (such as your name and email address), and/or any related services,
      ...
      <ol class="underline text-brand-purple flex flex-col space-y-1">
        <li><a href="#1">WHAT INFORMATION DO WE COLLECT?</a></li>
        <li><a href="#2">YOUR INFORMATION BE SHARED WITH ANYONE?</a></li>
        <li><a href="#3">HOW LONG DO WE KEEP YOUR INFORMATION?</a></li>
        <li><a href="#4">HOW DO WE KEEP YOUR INFORMATION SAFE?</a></li>
        <li><a href="#5">DO WE COLLECT INFORMATION FROM MINORS?</a></li>
        <li><a href="#6">WHAT ARE YOUR PRIVACY RIGHTS?</a></li>
        <li><a href="#7">DATA BREACH</a></li>
      ...
      <p>
        ...
        name, last name, and nickname; email addresses; and other similar data.
      </p>
      <p>
      ...
      <p>
        ...
        navigate the Services, via Google Analytics. This information does not
      ...
      <br />
      <p>
        <b>Online Identifiers.</b> We collect cookie identifiers, or others such
        as the ones used for analytics and marketing; and other similar data.
      </p>
      <br />

      <h5 id="2">2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</h5>
      ...
      <h5 id="3">3. HOW LONG DO WE KEEP YOUR INFORMATION?</h5>
      ...
      <h5 id="4">4. HOW DO WE KEEP YOUR INFORMATION SAFE?</h5>
      ...
      <h5 id="5">5. DO WE COLLECT INFORMATION FROM MINORS?</h5>
      ...
      <p>
        ...
        will be notified about data breaches we believe you are likely to be at
        risk or serious harm. For example, a data breach may be likely to result
        in serious financial harm or harm to your mental or physical well-being.
        In the event that we become aware of a security breach which has
        resulted or may result in unauthorized access, use or disclosure of
        personal information, we will promptly investigate the matter and notify
      ...
      <h5 id="8">8. CONTROLS FOR DO-NOT-TRACK FEATURES</h5>
      ...
      <h5 id="9">9. DO WE MAKE UPDATES TO THIS POLICY?</h5>
      ...
      <h5 id="10">10. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</h5>
     ...
     <div
      @click="$router.back()"
      class="flex flex-row space-x-2 items-center pt-4"
    >
      <svg
